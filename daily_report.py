...
def generate_ai_script(market_stats, ai_focus_items):
    ...
    【寫作要求】
    1. **自然流暢**：請順暢地介紹這 6 個物品，**不要**使用「紅榜區」、「警示區」這種生硬的分類標題。就像你在跟朋友講今天發生了什麼大新聞一樣，一段一段講下來。
    2. **情緒起伏**：
    ...
    try:
        ...
        # 優先順序：2.0 Flash -> 1.5 Flash -> 任何 Flash
